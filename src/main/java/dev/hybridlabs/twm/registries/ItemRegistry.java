...
import dev.hybridlabs.twm.items.weapons.*;
...
import dev.hybridlabs.twm.items.weapons.swords.*;
...
public class ItemRegistry {
  ...
  public static final RegistryObject<Item> THE_BLOODTHIRSTER_CLAYMORE = ITEMS.register("the_bloodthirster_claymore", () -> new BloodthirsterItem(WeaponrySwordTiers.BLOODTHIRSTER, 3.0F, -2.7F, new Item.Properties()));
  ...
  public static final RegistryObject<Item> OBSIDIAN_TIPPED_DIAMOND_PICKAXE = ITEMS.register("obsidian_tipped_diamond_pickaxe", () -> new PickaxeItem(WeaponryToolTiers.OBSIDIAN_EDGED_DIAMOND, 1, -2.8F, new Item.Properties()));
