...
public class BlockRegistry {
  ...
  public static final RegistryObject<Block> ANCIENT_DEBRIS = BLOCKS.register("ancient_debris", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.ANCIENT_DEBRIS).strength(30.0f, 1200.0f).requiresCorrectToolForDrops()));
  ...
  public static final RegistryObject<Block> BRIGHTSTEEL_BLOCK = BLOCKS.register("brightsteel_block", () -> new Block(BlockBehaviour.Properties.copy(STEEL_BLOCK.get()).strength(200.0f, 1200.0f).lightLevel((bs) -> 15).requiresCorrectToolForDrops()));
